...
用自然语言叙述为：调和平均数 ≤ 几何平均数 ≤ 算术平均数 ≤ 平方平均数（均方根）．简记为：**「调几算平」**．
...
对于 D，对原式配方得 $\left(x-\dfrac y2\right)^2+\left(\dfrac{\sqrt3y}2\right)^2=1$，使用 **三角换元** 法，设
$$
...
$$
当且仅当 $y^2=\dfrac12,x^2=\frac3{10}$ 时等号成立．
