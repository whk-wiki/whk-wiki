...
已知数列 $a$ 的通项公式为 $a_n = (n + 1)\l(\df{9}{10}\r)^n$，求 $a$ 的最大项．
...
$$
\begin{aligned}
f(n) = a_{n + 1} - a_n &= (n + 2)\l(\df{9}{10}\r)^{n + 1} - (n + 1)\l(\df 9{10}\r)^n \\
&= \l(\df 9 {10}\r)^n\l[\df 9 {10}(n + 2) - (n + 1)\r] \\
&= \df{8 - n}{10} \cdot \l(\df 9 {10}\r)^n
\end{aligned}
$$
...
已知数列 $a$ 满足 $a_1 = 2$，$2a_na_{n + 1} = {a_n}^2 + 1$，求证：$\l\{\df{a_n - 1}{a_n + 1}\r\}$ 递减．
