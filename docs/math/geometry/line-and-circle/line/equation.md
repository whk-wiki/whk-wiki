...
也可以给出经过不重合的两点 $P_1(x_1, y_1)$，$P_2(x_2, y_2)$ 的直线方程，而且 **没有水平或竖直** 的要求．但也没什么用．
...
- $m$ 取遍所有实数时，含参直线能取到的范围是过交点 $(9, -4)$ 且不与 $x + 2y - 1=  0$ 重合的所有直线（这是方程恒成立角度无法给出的信息）．

因此笔者通常更推荐 **交点直线系** 的理解，除非题目不仅有 $m$ 项还有 $m^2$ 项，方程变形为 $am^2 + bm + c = 0$，恒成立等价 $a = 0$ 且 $b = 0$ 且 $c = 0$，这套思路必须用方程恒成立的角度理解．
