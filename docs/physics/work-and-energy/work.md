...
比如以 $\pu{100 m*s-1}$ 的速度匀速运行的火车上，一个人正在以 $\pu{1N}$ 的力 $F$ 匀速推动箱子，箱子运动速度相对于火车为 $\pu{1m*s-1}$，相对于地面为 $\pu{101m*s-1}$．
...
即一对相互作用力做功之和，只与力和 $A$ 相对 $B$ 运动的路径有关．注意到 $A$ 相对 $B$ 运动的路径是与选取的参考系无关的，因此 **一对相互作用力做功之和与参考系无关**．这是非常特殊，经典且重要的一个做功与参考系无关的特例．
...
另外，当我们对系统受力分析时，系统的内力一定是完整的几对相互作用力．因此，**系统内力之和为零，系统内力做功之和在不同参考系下相同**．
...
通常情况来讲，支持力与物体运动方向始终垂直（读者不妨考虑一下物体在平面上运动，或者在圆弧上运动，会发现大多数情况下都是如此）．因此积分的结果是 $0$，即支持力通常不做功．

:::warning 支持力并不一定与物体运动方向始终垂直

考虑一辆水平向右匀速运动的火车，火车内有一从左向右下降的斜面，斜面上有一滑块，滑块沿斜面下落，斜面静止不动．

整个过程中，滑块受到斜面的支持力是否对斜块做功？如果我们以车厢为参考系，则不做功；但如果以地面为参考系，支持力是做功的，因为支持力和物体相对于地面的位移并不垂直．
...
如图所示，一物体以 $\pu{3m * s-1}$ 的初速度从曲面 $A$ 点下滑到第一次运动到 $B$ 点，摩擦力做功为 $W_1$；该物体再次以 $\pu{2m * s-1}$ 的初速度由 $A$ 点下滑到第一次运动到 $B$ 点，摩擦力做功为 $W_2$，试比较 $W_1$ 和 $W_2$．
